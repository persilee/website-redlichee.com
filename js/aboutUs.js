$(document).ready(function() {
    ...
    $('.aboutUs .dc_nav li').click(function(){
      $('.aboutUs .dc_nav li').removeClass('active');
      if ($(this).html() == '关于红荔') {
        $('.aboutUs .text').css('display','none');
        $('.aboutUs .AboutUs').fadeIn('slow');
      }
      if ($(this).html() == '人才招聘') {
        $('.aboutUs .text').css('display','none');
        $('.aboutUs .recruitment').slideDown('slow');
      }
      if ($(this).html() == '联系我们') {
        $('.aboutUs .text').css('display','none');
        $('.aboutUs .contactUs').fadeIn('slow');
      }
